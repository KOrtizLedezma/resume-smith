...
def build_prompt(job_description: str) -> str:
    ...
    system_prompt = (
        "What is the job title mentioned in the job description?\n"
        "Provide ONLY the job title as a single line of text.\n"
    )
...
if __name__ == "__main__":
    ...
    prompt_output_path = Path("data/prompts/job_title_prompt.txt")
